...
# (No standardisation step!)

# Clustering
nb_clusters <- 4
m1 <- mestimate(exprSet)  # Estimate m without standardization
...
mfuzz.plot(exprSet, cl=cl, mfrow=c(2, 2), time.labels=c("0", "1", "2"), new.window=FALSE)
dev.off()
