...
merged_d <- "/Users/zainabnazari/mfuzz/data/merged_df_mRNA.xlsx"
...
rownames(exprs_scaled) <- datafile$ID
...
# Output directory
output <- "/Users/zainabnazari/mfuzz/mRNA/cluster_output"
...
pdf(file.path(dir, "clusters_cutoff_0.7_n_3_try_0.pdf"), width=10, height=5)
